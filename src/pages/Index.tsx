  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | The Barbershop IBO</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop The Barbershop IBO in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="The Barbershop IBO | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="The Barbershop IBO | Premium Barbershop Berlin" />
        <meta
